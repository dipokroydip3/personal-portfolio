...
const Contact = () => {
      return (
            <div className="">
                  ...
                  <h2 className="text-center text-5xl font-semibold"><i>Contact Me</i></h2>
                  <div className="lg:w-7/12 border-gray-300 shadow-2xl py-10 px-5 rounded border border-solid m-auto mt-10">
                        ...
                        <Link target="_blank" to="https://mail.google.com/mail/u/0/#inbox?compose=jrjtXJRtZnXWncMQgRXlZCxltXCWrMBwlncZKwZWbBqXRnwTRGNTcvMjTzSSnPqlRwkjsvjs">
